...
function getAllMonth(date){
	$.ajax({
		url : ctxRoot + "/data/getSupplierReportValueList",
		type : 'post',
		data : {
			"reportType":"day",
		}, 
...
function more(list){
	...
	for(var i=0;i<list.length;i++){
		if(list[i].label == "其他"){
			more ={"label":"其他","value":list[i].value};
		}
	}
...
function getChartData(reportValue){
	...
	$.ajax({
		url : ctxRoot + "/data/supplierdailyAnalysis",
		type : 'post',
		data : {
...
function quoteRatio2(data){
	var fusioncharts = new FusionCharts({
	    type: 'bar2d',
	    renderAt: 'quoteRatioChart2',
	    width: '400',
	    height: '280',
	    dataFormat: 'json',
	    dataSource: {
	    ...
	    "events": {
	    	"renderComplete": function () {
	    		$('#quoteRatioChart2 tspan').each(function() {
	    			if($(this).text() == "FusionCharts XT Trial"){
	    				$(this).remove();
	    			}
	    	    });
...
function tradeRatio2(data){
	var fusioncharts = new FusionCharts({
		 type: 'bar2d',
		    renderAt: 'tradeRatioChart2',
		    width: '400',
		    height: '280',
		    dataFormat: 'json',
		    dataSource: {
	    ...
	    "events": {
	    	"renderComplete": function () {
	    		$('#tradeRatioChart2 tspan').each(function() {
	    			if($(this).text() == "FusionCharts XT Trial"){
	    				$(this).remove();
	    			}
	    	    });
...
function incomeRatio2(data){
	var fusioncharts = new FusionCharts({
		 type: 'bar2d',
		    renderAt: 'incomeRatioChart2',
		    width: '400',
		    height: '280',
		    dataFormat: 'json',
		    dataSource: {
	    ...
	    "events": {
	    	"renderComplete": function () {
	    		$('#incomeRatioChart2 tspan').each(function() {
	    			if($(this).text() == "FusionCharts XT Trial"){
	    				$(this).remove();
	    			}
	    	    });
...
function putRatioChart2(data){
	var fusioncharts = new FusionCharts({
	    type: 'bar2d',
	    renderAt: 'putRatioChart2',
	    width: '400',
	    height: '280',
	    dataFormat: 'json',
	    dataSource: {
	    	 "chart": {
		        ...
		        "data":data.putRatioValue
	    },
	    "events": {
	    	"renderComplete": function () {
	    		$('#putRatioChart2 tspan').each(function() {
	    			if($(this).text() == "FusionCharts XT Trial"){
	    				$(this).remove();
	    			}
	    	    });
...
function incomeAPR1(data){
	var fusioncharts = new FusionCharts({
	    type: 'pie3d',
	    renderAt: 'incomeAPRChart',
	    width: '400',
	    height: '280',
	    dataFormat: 'json',
	    dataSource: {
	    ...
	    "events": {
	    	"renderComplete": function () {
	    		$('#incomeAPRChart tspan').each(function() {
	    			if($(this).text() == "FusionCharts XT Trial"){
	    				$(this).remove();
	    			}
	    	    });
...
function tradeAPR2(data){
	var fusioncharts = new FusionCharts({
	    type: 'bar2d',
	    renderAt: 'tradeAPRChart2',
	    width: '400',
	    height: '280',
	    dataFormat: 'json',
	    dataSource: {
	    ...
	    "events": {
	    	"renderComplete": function () {
	    		$('#tradeAPRChart2 tspan').each(function() {
	    			if($(this).text() == "FusionCharts XT Trial"){
	    				$(this).remove();
	    			}
	    	    });
...
function quoteAPR2(data){
	var fusioncharts = new FusionCharts({
	    type: 'bar2d',
	    renderAt: 'quoteAPRChart2',
	    width: '400',
	    height: '280',
	    dataFormat: 'json',
	    dataSource: {
	    ...
	    "events": {
	    	"renderComplete": function () {
	    		$('#quoteAPRChart2 tspan').each(function() {
	    			if($(this).text() == "FusionCharts XT Trial"){
	    				$(this).remove();
	    			}
	    	    });
